          ...
          <div className="contact-details">
            <ul>
              <li>
                <h5>Email</h5>
                <p>
                  suvashinidaliya@gmail.com <span>(Recommended)</span>
                </p>
              </li>
              <li>
                <h5>Skype</h5>
                <p>
                  suvaashini <span>(Available)</span>
                </p>
              </li>
              <li>
                <h5>Social</h5>
                <p>
                  Facebook/Twitter - @suvashini <span>(Always Available)</span>
                </p>
              </li>
              <li>
                <h5>Address</h5>
                <p>Kariya, Kachua, Chandpur, Bangladesh - 3632</p>
              </li>
            </ul>
          </div>
        </div>
